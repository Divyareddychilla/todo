    ...
    <div className='app'>
      <div className='container'>
        ...
        <div className='todo_checkmark_div'>
          {data && data.todos && data.todos.map((todo: Todo) => (
        ...
        <h3 className='completedtaskheading'>
          ...
          {completedTasks.map((completedTodo) => (
            <div className="todo_card todo_content" key={completedTodo.todo_id}>
              <p className="completed_task_title">{completedTodo.title}</p>
            </div>
          ))}
        </div>
      </div>
